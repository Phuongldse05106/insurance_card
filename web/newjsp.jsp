<%-- 
    Document   : newjsp
    Created on : Apr 20, 2022, 6:10:22 PM
    Author     : dell
--%>
                                                ...
                                                <td>
                                                    <div class="d-flex px-2 py-1">
                                                        <div class="d-flex flex-column justify-content-center">
                                                            <h6 class="mb-0 text-sm">${i.userId}</h6>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>
                                                    <p class="text-xs font-weight-bold mb-0">${i.fullName}</p>
                                                </td>
                                                <td class="align-middle text-center text-sm">
                                                    <span class="badge badge-sm bg-gradient-success">${i.email}</span>
                                                </td>
                                                <td class="align-middle text-center">
                                                    <span class="text-secondary text-xs font-weight-bold">${i.username}</span>
                                                </td>
                                                <td class="align-middle">
                                                    <span class="text-secondary text-xs font-weight-bold">${i.role}</span>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
