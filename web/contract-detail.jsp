          ...
          <div class="container-fluid py-1 px-3">
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                ...
                <li class="breadcrumb-item text-sm text-dark active" aria-current="page">contract-detail</li>
              </ol>
                ...
                <div class="card my-4">
                  ...
                  <div class="card-body px-0 pb-2">
                    <div class="table-responsive p-0">
                        <form action="contract-detail" method="POST" class="m-3 mx-3">
                            <div class="form-row">
                                    ...
                                    <table>
                                        ...
                                        <c:if test = "${contract.status == 'accepted'}">
                                            <tr>
                                                ...
                                                <td style="padding-left: 10px">12 tháng</td>
                                            </tr>
                                        </c:if>
                                    </table>
                                </div>
