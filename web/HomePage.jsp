...
<html>
    ...
    <body>
        ...
        <section id="footer">
            <img src="images/baohiem.jpg" class="footer-img">
            <div class="title-text">
                <p>Contact</p>
                <h1>Visit Website</h1>
            </div>
