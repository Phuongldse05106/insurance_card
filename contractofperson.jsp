        ...
        <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
            ...
            <div class="collapse navbar-collapse  w-auto  max-height-vh-100" id="sidenav-collapse-main">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link text-white active bg-gradient-primary" href="contractofperson.jsp">
                            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                                <i class="material-icons opacity-10">table_view</i>
                            </div>
            ...
            <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" navbar-scroll="true">
                <div class="container-fluid py-1 px-3">
                    <nav aria-label="breadcrumb">
                        ...
                        <h6 class="font-weight-bolder mb-0">Hợp đồng</h6>
                    </nav>
          ...
          <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                <h6 class="text-white text-capitalize ps-3">Thông tin hợp đồng</h6>
              </div>
            </div>
              ...
              <div class="table-responsive p-0">
                <table class="table align-items-center mb-0">
                  <thead>
                    <tr>
                      <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Mã hợp đồng</th>
                      <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Tên hợp đồng</th>
                  ...
                  <c:forEach items="${a.personContract}" var="c">
                      <c:choose>
                          <c:when  test = "${c.userId == sessionScope.acc.userId}">
                  <tbody>
                    <tr>
                      <td>
                        <div class="d-flex px-2 py-1">
                          <div class="d-flex flex-column justify-content-center">
                            <h6 class="mb-0 text-sm">${c.contractId}</h6>
                          </div>
                        </div>
                      </td>
                      <td>
                      ...
                      <td class="align-middle text-center">
                        <span class="text-secondary text-xs font-weight-bold">${c.date}</span>
                      </td>
                      <td class="align-middle text-center text-sm">
                          <c:choose>
                          <c:when  test = "${c.status == 'true'}">
                        <span class="badge badge-sm bg-gradient-success">${c.status == "true" ? "Còn hiệu lực" : "Hết hiệu lực"}</span>
                        </c:when>
                        <c:otherwise>
                            <span class="badge badge-sm bg-gradient-secondary">${c.status == "true" ? "Còn hiệu lực" : "Hết hiệu lực"}</span>
                        </c:otherwise>
                          </c:choose>
                          </td>
